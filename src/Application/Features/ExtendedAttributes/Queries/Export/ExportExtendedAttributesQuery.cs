...
using MinhasNoticias.Application.Specifications.ExtendedAttribute;
using MinhasNoticias.Domain.Contracts;
using MinhasNoticias.Domain.Enums;
using MinhasNoticias.Shared.Wrapper;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Localization;

namespace MinhasNoticias.Application.Features.ExtendedAttributes.Queries.Export
{
