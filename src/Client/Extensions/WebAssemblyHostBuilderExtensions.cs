...
using MinhasNoticias.Client.Infrastructure.Authentication;
using MinhasNoticias.Client.Infrastructure.Managers;
using MinhasNoticias.Client.Infrastructure.Managers.Preferences;
...
using MinhasNoticias.Client.Infrastructure.Managers.ExtendedAttribute;
using MinhasNoticias.Domain.Entities.ExtendedAttributes;
using MinhasNoticias.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace MinhasNoticias.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        private const string ClientName = "MinhasNoticias.API";
