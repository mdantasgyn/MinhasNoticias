...
using AutoMapper;
using MinhasNoticias.Application.Exceptions;
using MinhasNoticias.Application.Extensions;
...
using MinhasNoticias.Infrastructure.Specifications;
...
namespace MinhasNoticias.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "admin@blazorstore.com")
            {
