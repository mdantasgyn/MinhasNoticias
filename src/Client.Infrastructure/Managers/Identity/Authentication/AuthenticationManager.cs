...
using MinhasNoticias.Client.Infrastructure.Extensions;
using MinhasNoticias.Client.Infrastructure.Routes;
...
namespace MinhasNoticias.Client.Infrastructure.Managers.Identity.Authentication
{
