...
using MinhasNoticias.Application.Features.ExtendedAttributes.Commands.Delete;
...
using MinhasNoticias.Application.Features.ExtendedAttributes.Queries.GetById;
using MinhasNoticias.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace MinhasNoticias.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
