...
using MinhasNoticias.Application.Features.DocumentTypes.Commands.Delete;
using MinhasNoticias.Application.Features.DocumentTypes.Queries.Export;
...
namespace MinhasNoticias.Server.Controllers.Utilities.Misc
{
